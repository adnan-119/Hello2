...
def services(request):
    if request.method == "POST":
        ...
        services = RentCar(name=name, email=email, phone=phone, destination=destination,pickdate = pickdate,pickuptime = pickuptime,dropdate=dropdate,droptime=droptime,pickup=pickup,model=model)
        services.save()
        return render(request,'payment.html')
...
def carbooking(request):
    if request.method == "POST":
        ...
        dropdate = request.POST.get('dropdate')
        droptime = request.POST.get('droptime')
        carbooking = CarBooking(name=name, email=email, phone=phone, destination=destination,pickdate = pickdate,pickuptime = pickuptime,dropdate=dropdate,droptime=droptime,pickup=pickup,model=model)
        carbooking.save()
...
@login_required(login_url='login')
def carbookcalculator(request):
    return render(request, 'carbookcal.html')
